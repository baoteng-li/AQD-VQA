...
def eval(args):
    ...
    for id in tqdm(json_data):
        ...
        prompt = 'Based on the picture, answer this question, give a clear answer at the beginning of your answer: '+question
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_file", type=str, default="result/intros_val_3000_internvl2.json")
