...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_path", type=str, default='gqa_result/sub_questions_gqa_test.json')
    parser.add_argument("--save_file", type=str, default='result/sub_answer_gqa_test_qwen.json')
