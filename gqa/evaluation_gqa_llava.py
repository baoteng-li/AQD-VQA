...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_file", type=str, default='result/final_answer_gqa_test_llava_13b.json')
    parser.add_argument("--sub_qa_path", type=str, default='result/sub_answer_gqa_test_llava_13b.json')
