...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_file", type=str, default='result/final_answer_introspect_val_3000_internvl2.json')
    parser.add_argument("--sub_qa_path", type=str, default='result/sub_answer_introspect_val_3000_internvl2.json')
