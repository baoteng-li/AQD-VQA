...
Answer questions based on images, and provide the reasons:
$input_questions
""".strip())
...
def eval(args):
    ...
    for i in tqdm(range(len(json_data))):
        ...
        ori_question = json_data[i].get("question")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_path", type=str, default='result/sub_questions_introspect_val_3000.json')
    parser.add_argument("--save_file", type=str, default='result/sub_answer_introspect_val_3000_llava.json')
